...
ssh pi@$PI_NODE_NAME cat /etc/tinc/rpinet/hosts/$PI_NODE_NAME | sudo tee /etc/tinc/rpinet/hosts/$PI_NODE_NAME
cat /etc/tinc/rpinet/hosts/laptop | ssh pi@$PI_NODE_NAME sudo tee /etc/tinc/rpinet/hosts/laptop